...
theme_list = ['ALTERNATIVE_MEDICINE', 'CONSPIRACY', 'SAFETY_CONCERNS', 'CIVIL_LIBERTIES', 'PERSONS_OF_INTEREST', 'REAL']
...
def create_tweet_label_dict(tweet_anno_file):
    ...
    for id in data.keys():
        ...
        if data[id][0] in se_emb.keys():
            ...
            if se_emb[data[id][0]] == 2 or se_emb[data[id][0]] == 3:
                anno_dict[int_id]['severity'] = 2
            else:
            ...
            anno_dict[int_id]['theme'] = theme_emb[data[id][4]]
...
def apn_skl(y_true, y_pred, list_type):
    ...
    p, r, f, s = met.precision_recall_fscore_support(y_true, y_pred, average=None, zero_division=0)
    mp, mr, m, ms = met.precision_recall_fscore_support(y_true, y_pred, average='micro', zero_division=0)
    print(f'============================')
